...
import net.runelite.client.util.DuelingRingMode;
import net.runelite.client.util.EssenceMode;
import net.runelite.client.util.GamesNecklaceMode;
import net.runelite.client.util.GloryMode;
